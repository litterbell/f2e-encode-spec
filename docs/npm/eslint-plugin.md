...
```shell
$ npm install eslint-plugin-bell eslint --save-dev
```
...
// .eslintrc.js
module.exports = {
  plugin: ['eslint-config-bell'],
  rules: {
    'eslint-plugin-bell/no-secret-info': 'error',
  },
};
```
...
// .eslintrc.js
module.exports = {
  extends: 'plugin:eslint-plugin-bell/recommended',
};
```
